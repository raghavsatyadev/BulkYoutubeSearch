...
suspend fun Context.clearAllPrefs() {
    dataStore.edit { it.clear() }
}

inline fun <reified T> Fragment.getPrefs(
    key: String,
    defaultValue: T?,
): Flow<T?> {
    return requireContext().getPrefs(key, defaultValue)
}