...
object OrientationExtensions {
  /**
   * will set [ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE] if it is tab or TV otherwise it
   * will set [ActivityInfo.SCREEN_ORIENTATION_PORTRAIT]
   */
   ...
   *   [ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE], if false first it will go in
   *   [ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT] than
